...
session_set_save_handler(
	   array("SessionStorage", "sopen"),
	   array("SessionStorage", "sclose"),
	   array("SessionStorage", "sread"),
	   array("SessionStorage", "swrite"),
	   array("SessionStorage", "sdestroy"),
	   array("SessionStorage", "sgc"));
?>