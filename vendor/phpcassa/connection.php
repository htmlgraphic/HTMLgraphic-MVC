...
class Connection {
    ...
    private static $default_servers = array(
    		array('host' => '172.16.15.1', 'port' => 9160),
    		array('host' => '172.16.15.2', 'port' => 9160),
    		array('host' => '172.16.15.3', 'port' => 9160),
    		array('host' => '172.16.15.4', 'port' => 9160),
    		);
    ...
    public function connect() {
		...
		//sleep(2);
	//	error_log("mark dead, retry");
            //error_log("mark dead, retry " . print_r($e,true));
		return $this->connect();
        }
